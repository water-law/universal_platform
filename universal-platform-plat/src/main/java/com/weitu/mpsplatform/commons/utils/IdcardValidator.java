...
public class IdcardValidator {
    ...
    public static boolean isValidatedIdcard(String idcard) {
        if (SString.isBlank(SString.getTrimString(idcard))) {  
            return false;  
        }  
        if (idcard.length() == 15) {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        String idcard18 = "35021219940902505X";
        // 15位身份证  
        System.out.println(isValidatedIdcard(idcard15));
        // 18位身份证  
        System.out.println(isValidatedIdcard(idcard18));
        // 15位身份证转18位身份证  
